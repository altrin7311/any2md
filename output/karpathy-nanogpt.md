...
license: "MIT"
languages: [Python]
tags: [nanoGPT, minGPT, GPT, natural language processing]
---

# karpathy/nanoGPT

> **Summary:** The nanoGPT repository is a simplified version of the minGPT model, prioritizing speed and ease of use. It allows for fast training and fine-tuning of medium-sized GPTs.

Key concepts: [[nanochat]], [[OpenWebText]]
